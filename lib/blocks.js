...
function BlocksPlugin(game, opts) {
  ...
  registry.registerBlock('bedrock', {texture: 'bedrock'});
  ...
  registry.registerBlock('wool', {texture: {back: 'wool_colored_gray', front: 'wool_colored_white', top: 'wool_colored_green', bottom: 'wool_colored_light_blue', left: 'wool_colored_red', right: 'wool_colored_yellow'}})
